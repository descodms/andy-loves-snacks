...
function ajaxHeart(e) {
  ...
  _axios2.default.post(this.action).then(function (res) {
    ...
    var isHearted = (0, _bling.$)('.heart-count').textContent = res.data.hearts.length;
    ...
    if (currentPath === '/hearts') {
      setTimeout(function () {
        return _this.parentNode.parentNode.parentNode.parentNode.remove();
      }, 1500);
    }
  }).catch(console.error);
}
...
function typeAhead(search) {
  ...
  searchInput.on('keyup', function (e) {
    ...
    var elementDesactive = (0, _bling.$)('#store-' + active);
    if (elementDesactive) {
    ...
    var elementActive = (0, _bling.$)('#store-' + active);
    if (elementActive) {
